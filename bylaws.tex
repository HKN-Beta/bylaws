...
At the beginning of each semester, all members will be reviewed for academic integrity standing. Any member found to have committed an academic integrity violation will have a 2 week probationary period to meet with the club advisors to appeal their status. If the member does not meet with the advisors within the 2 week period, or if the advisors upholds the violation, the member will be suspended from the chapter.
...
\subsection{}
The Executive Committee shall be authorized to make expenditures not exceeding a cumulative total of \$200 between active meetings for goods and services necessary to the operation of the Chapter without prior approval of the general membership. All such expenditures shall be reported in full at the next active meeting, at which time the discretionary spending limit shall be reset.
...
\section{Honors}
\subsection{}
Upon graduation, having completed at least one semester of active membership in the Chapter, active members are entitled to receive a paddle and rent a stole. The cost of the paddle shall be covered for one graduation. Upon additional graduations, graduates are eligible to purchase a paddle and/or a stole from the Chapter at their own expense.
