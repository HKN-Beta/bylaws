...
At the beginning of each semester, all members will be reviewed for academic integrity standing. Any member found to have committed an academic integrity violation will be removed via the member removal process outlined in \ref{Member Removal Process}.
...
An officer may be removed from their position through an impeachment process initiated via Roberts Rules of Order during a regular or special meeting. Grounds for impeachment include, but are not limited to, failure to perform the duties of the office, violation of Chapter bylaws, or conduct detrimental to the Chapter. A two-thirds majority vote of the active members present is required to remove an officer from their position. 
